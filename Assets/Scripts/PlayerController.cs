...
public class PlayerController : MonoBehaviour ,IDragHandler,IPointerUpHandler,IPointerDownHandler {
    ...
    public virtual void OnDrag(PointerEventData ped)
    {
        ...
        if (RectTransformUtility.ScreenPointToLocalPointInRectangle(bgImg.rectTransform, ped.position, ped.pressEventCamera, out pos))
        {
            ...
            inputVector = new Vector3(pos.x -0.8f, 0, pos.y-0.9f);


            inputVector = (inputVector.magnitude > 1.0f) ? inputVector.normalized : inputVector;
            joistickImg.rectTransform.anchoredPosition = new Vector3(inputVector.x * (bgImg.rectTransform.sizeDelta.x/2)
    ...
    public virtual void OnPointerUp(PointerEventData ped)
    {
        ...
        joistickImg.rectTransform.anchoredPosition = Vector3.zero;
    }
